...
from model_lib.data import SampleGenerator
from model_lib.config import MODEL_SPEC
...
def train(args):
    ...
    print('Range of LocationId is [{}, {}]'.format(wework_rating.location_id.min(), wework_rating.location_id.max()))
